    ...
    for (let configIndex = 0; configIndex < runConfig.length; configIndex++) {
        ...
        it("Init the deploy contract", async () => {
            ...
            for (let index = 0; index < weightTest.length; index++)
                tokenWeightList[tokenWeightList.length] = new BN(
                    (weightTest[index] * 10 ** 18)
                        .toLocaleString()
                        .replace(/,/g, "")
                );
            ...
            for (let index = 0; index < xCollateralAddress.length; index++) {
                await xCollateralObject[xCollateralAddress[index]].setAuthority(
                    dfEngine.address
                );
                await dfPool.approveToEngine(
                    xCollateralAddress[index],
                    dfEngine.address
                );
            ...
            await dfSetting.setCommissionMedian(
                dfToken.address,
                medianizer.address
            );
        ...
        it("Verify DFEngine Complex after construction", async () => {
            ...
            while (dfEngineTimes < configTimes) {
                ...
                dfEngineIndex =
                    dfEngineTimes % runConfig[configIndex]["data"].length;
                runType = runConfig[configIndex]["data"][
                    dfEngineIndex
                ].hasOwnProperty("type")
                ...
                if (
                    ...
                    runTimes =
                        runConfig[configIndex]["data"][dfEngineIndex]["times"];
                }

                console.log(
                    "runType : " + runType + " runTimes : " + runTimes + "\n"
                );
                ...
                switch (true) {
                        ...
                        while (condition < runTimes) {
                            ...
                            tokenAddress =
                                tokenAddressList[
                                    MathTool.randomNum(
                                        0,
                                        tokenAddressList.length - 1
                                    )
                                ];
                            accountAddress =
                                accounts[
                                    MathTool.randomNum(1, accounts.length - 1)
                                ];
                            amount = MathTool.randomNum(10, 500);

                            conditionIndex =
                                condition %
                                runConfig[configIndex]["data"][dfEngineIndex][
                                    "data"
                                ].length;
                            if (
                                runConfig[configIndex]["data"][
                                ...
                                if (
                                    runConfig[configIndex]["data"][
                                        dfEngineIndex
                                    ]["data"][conditionIndex].hasOwnProperty(
                                        "tokenAddress"
                                    )
                                ) {
                                    tokenAddress =
                                ...
                                if (
                                    ...
                                    amount =
                                        runConfig[configIndex]["data"][
                                            dfEngineIndex
                                        ]["data"][conditionIndex]["amount"];
                                }
                            }
                            var tokenDecimals =
                                collateralDecimals[
                                    collateralAddress.indexOf(tokenAddress)
                                ];
                            var xTokenAddress = await dfStore.getWrappedToken.call(
                                tokenAddress
                            );
                            assert.equal(
                                xTokenAddress,
                            ...
                            var amountReal = await xCollateralObject[
                                xTokenAddress
                            ...
                            console.log(
                                "deposit token name : " +
                                    (await collateralObject[
                                        tokenAddress
                                    ].name.call())
                            );
                            console.log(
                                "deposit token address : " + tokenAddress
                            );
                            console.log(
                            ...
                            console.log(
                                "deposit account address : " + accountAddress
                            );
                            console.log("\n");
                            ...
                            accountTokenBalanceOrigin = await collateralObject[
                                tokenAddress
                            ].balanceOf.call(accountAddress);
                            var tokenName = await collateralObject[
                                tokenAddress
                            ].name.call();

                            await collateralObject[
                                tokenAddress
                            ].approve(dfPool.address, new BN(0), {
                                from: accountAddress,
                            });
                            await collateralObject[
                                tokenAddress
                            ].approve(dfPool.address, amountNB, {
                                from: accountAddress,
                            });
                            ...
                            if (tokenAddressList.indexOf(tokenAddress) >= 0) {
                                calcDepositorMintTotal = await dfProtocolView.getUSDXForDeposit.call(
                                    tokenAddress,
                                    amountNB,
                                    { from: accountAddress }
                                );
                            ...
                            runData["accountAddress"] = accounts.indexOf(
                                accountAddress
                            );

                            runData["tokenAddress"] =
                                collateralAddress.indexOf(tokenAddress) + 1;
                            ...
                            runData["USDx balance"] =
                                usdxBalanceOrigin.toString() / 10 ** 18;
                            runData[
                                "USDx balance BN"
                            ] = usdxBalanceOrigin.toString();
                            ...
                            try {
                                transactionData = await dfProtocol.deposit(
                                    tokenAddress,
                                    new BN(0),
                                    amountNB,
                                    { from: accountAddress }
                                ...
                                runConfig[configIndex]["data"][dfEngineIndex][
                                    "data"
                                ][conditionIndex]["gasUsed"] =
                                    transactionData.receipt.gasUsed;
                                runConfig[configIndex]["data"][dfEngineIndex][
                                    "data"
                                ][conditionIndex]["result"] = "success";
                                runData["gasUsed"] =
                                    transactionData.receipt.gasUsed;
                                runData["gasUsed ETH"] =
                                    (transactionData.receipt.gasUsed *
                                ...
                                runConfig[configIndex]["data"][dfEngineIndex][
                                    "data"
                                ][conditionIndex]["result"] = "fail";
                                runConfig[configIndex]["data"][dfEngineIndex][
                                    "data"
                                ][conditionIndex]["error"] = error.message;
                                runData["result"] = "fail";
                            ...
                            for (
                                let index = 0;
                                index < collateralAddress.length;
                                index++
                            ) {
                                xTokenAddress = await dfStore.getWrappedToken.call(
                                    collateralAddress[index]
                                );

                                dfStoreTokenBalance[
                                    xTokenAddress
                                ] = await dfStore.getTokenBalance.call(
                                    xTokenAddress
                                );
                                ...
                                dfStoreLockTokenBalance[
                                    xTokenAddress
                                ] = await dfStore.getResUSDXBalance.call(
                                    xTokenAddress
                                );
                                ...
                                dfStoreAccountToken[
                                    xTokenAddress
                                ] = await dfStore.getDepositorBalance.call(
                                    accountAddress,
                                    xTokenAddress
                                );
                                ...
                                dfCollateralTokenBalance[
                                    ...
                                    xTokenAddress
                                ].balanceOf.call(dfCollateral.address);
                            ...
                            usdxBalance = await usdxToken.balanceOf.call(
                                accountAddress
                            );
                            ...
                            dfWithdrawBalances = {};
                            dfWithdrawBalances = await dfProtocolView.getUserWithdrawBalance.call(
                                { from: accountAddress }
                            );
                            ...
                            for (
                                ...
                                withdrawAmount = dfStoreTokenBalance[
                                    xTokenAddress
                                ].lt(dfStoreAccountToken[xTokenAddress])
                                    ? dfStoreTokenBalance[xTokenAddress]
                                    : dfStoreAccountToken[xTokenAddress];
                                srcTokenAmount = await xCollateralObject[
                                    xTokenAddress
                                ...
                                balanceOfSrcTokens = await xCollateralObject[
                                    xTokenAddress
                            ...
                            assert.equal(
                                ...
                                dfPoolTokenTotal
                                    .add(dfCollateralTokenTotal)
                                    .toString()
                            );
                            assert.equal(
                                dfPoolSrcTokenTotal.toString(),
                                usdxTotalSupply
                                    .add(dfStoreTokenTotal)
                                    .toString()
                            );
                            assert.equal(
                                dfPoolSrcTokenTotal.toString(),
                            ...
                            assert.equal(
                                dfStoreMintedTotal
                                    .sub(await dfStore.getTotalBurned.call())
                                    .toString(),
                                usdxTotalSupply.toString()
                            );
                            ...
                            accountTokenBalanceCurrent = await collateralObject[
                                tokenAddress
                            ].balanceOf.call(accountAddress);
                            assert.equal(
                                accountTokenBalanceOrigin
                                    .sub(amountReal)
                                    .toString(),
                            ...
                            ] = usdxBalance.toString();

                            runData[
                                "pool src token balance"
                            ] = dfPoolSrcTokenBalance;
                    ...
                    case runType == "destroy":
                        while (condition < runTimes) {
                            ...
                            dfnBalance = await dfToken.balanceOf.call(
                                accountAddress
                            );
                            usdxTotalSupplyOrigin = await usdxToken.totalSupply.call();
                            usdxBalanceOrigin = await usdxToken.balanceOf.call(
                            ...
                            console.log(
                                "destroy account index : " +
                                    accounts.indexOf(accountAddress)
                            );
                            console.log(
                                "destroy account address : " + accountAddress
                            );
                            ...
                            burnedOrigin = await dfStore.getSectionBurned.call(
                                await dfStore.getBurnPosition.call()
                            );
                            ...
                            for (
                                ...
                                balanceOfTokens = await dfStore.getTokenBalance.call(
                                    xTokenAddress
                                );
                                dfStoreTokenTotal = dfStoreTokenTotal.add(
                                    balanceOfTokens
                                ...
                                balanceOfTokens = await xCollateralObject[
                                    xTokenAddress
                                ].balanceOf.call(dfPool.address);
                                dfPoolTokenTotal = dfPoolTokenTotal.add(
                                    balanceOfTokens
                                ...
                                dfTokenBalance = await dfStore.getTokenBalance.call(
                                    xTokenAddress
                                );
                                dfAccountToken = await dfStore.getDepositorBalance.call(
                                    accountAddress,
                                    xTokenAddress
                                );
                            ...
                            assert.equal(
                                ...
                                dfPoolTokenTotal
                                    .add(dfStoreTotalColOrigin)
                                    .toString()
                            );
                            assert.equal(
                                dfPoolSrcTokenTotalOrigin.toString(),
                                usdxTotalSupplyOrigin
                                    .add(dfStoreTokenTotal)
                                    .toString()
                            );
                            assert.equal(
                            ...
                            await dfToken.approve(dfEngine.address, new BN(0), {
                                from: accountAddress,
                            });
                            ...
                            runData["amount"] =
                                ...
                                10 **
                                    (18 -
                                        (minBurnAmount.toString().length - 1));
                            runData["amountNB"] = amountNB.toString();
                            runData["min amount"] =
                                minBurnAmount.toString() / 10 ** 18;
                            ...
                            try {
                                transactionData = await dfProtocol.destroy(
                                    new BN(0),
                                    amountNB,
                                    { from: accountAddress }
                                );
                            ...
                            burnedCurrent = await dfStore.getSectionBurned.call(
                                await dfStore.getBurnPosition.call()
                            );
                            ...
                            for (
                                ...
                                withdrawAmount = balanceOfTokens.lt(
                                    dfAccountToken
                                )
                                    ? balanceOfTokens
                                    : dfAccountToken;
                                ...
                                balanceOfTokens = await dfStore.getResUSDXBalance.call(
                                    xTokenAddress
                                );
                                dfStoreLockTokenTotal = dfStoreLockTokenTotal.add(
                                    balanceOfTokens
                            ...
                            assert.equal(
                                burnedTotalCurrent
                                    .sub(burnedTotalOrigin)
                                    .toString(),
                                amountNB.toString()
                            );
                            // assert.equal(burnedCurrent.sub(burnedOrigin).toString(), amountNB.toString());
                            assert.equal(
                                dfStoreTotalColOrigin
                                    .sub(dfStoreTotalColCurrent)
                                    .toString(),
                                amountNB.toString()
                            );
                            assert.equal(
                                usdxTotalSupplyOrigin
                                    .sub(usdxTotalSupplyCurrent)
                                    .toString(),
                                amountNB.toString()
                            );
                            assert.equal(
                                usdxBalanceOrigin
                                    .sub(usdxBalanceCurrent)
                                    .toString(),
                                amountNB.toString()
                            );
                            assert.equal(
                            ...
                            assert.equal(
                                dfPoolSrcTokenTotal.toString(),
                                dfPoolTokenTotal
                                    .add(dfStoreTotalColCurrent)
                                    .toString()
                            );
                            assert.equal(
                                dfPoolSrcTokenTotal.toString(),
                                usdxTotalSupplyCurrent
                                    .add(dfStoreTokenTotal)
                                    .toString()
                            );
                            assert.equal(
                            ...
                            runData[
                                "pool src token balance current"
                            ] = dfPoolSrcTokenBalance;
                            runDataList[runDataList.length] = runData;
                            condition++;
                        }
                    ...
                    case runType == "withdraw":
                        while (condition < runTimes) {
                            ...
                            amount = MathTool.randomNum(
                                0,
                                Number(
                                    amountTotal.mul(new BN(11)).div(new BN(10))
                                )
                            );
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    amount =
                                        amount * 10 ** tokenDecimals.toString();
                                }
                            ...
                            console.log(
                                "withdraw token address : " + tokenAddress
                            );
                            console.log(
                            ...
                            console.log(
                                "withdraw account address : " + accountAddress
                            );
                            console.log("\n");
                            ...
                            dfStoreTokenBalanceOrigin = await dfStore.getTokenBalance.call(
                                xTokenAddress
                            );
                            dfStoreLockTokenBalanceOrigin = await dfStore.getResUSDXBalance.call(
                                xTokenAddress
                            );
                            dfStoreAccountTokenOrigin = await dfStore.getDepositorBalance.call(
                                accountAddress,
                                xTokenAddress
                            );
                            ...
                            console.log(
                                dfStoreLockTokenBalanceOrigin.toString()
                            );
                            ...
                            dfPoolTokenBalanceOrigin = await xCollateralObject[
                                xTokenAddress
                            ].balanceOf.call(dfPool.address);
                            accountTokenBalanceOrigin = await collateralObject[
                                tokenAddress
                            ...
                            try {
                                transactionData = await dfProtocol.withdraw(
                                    tokenAddress,
                                    new BN(0),
                                    amountNB,
                                    { from: accountAddress }
                            ...
                            amountMin = new BN(0);
                            amountMin = amountTotal.lt(amountReal)
                                ? amountTotal
                                : amountReal;
                            ...
                            dfStoreTokenBalanceCurrent = await dfStore.getTokenBalance.call(
                                xTokenAddress
                            );
                            dfStoreLockTokenBalanceCurrent = await dfStore.getResUSDXBalance.call(
                                xTokenAddress
                            );
                            dfStoreAccountTokenCurrent = await dfStore.getDepositorBalance.call(
                                accountAddress,
                                xTokenAddress
                            );
                            dfPoolTokenBalanceCurrent = await xCollateralObject[
                                xTokenAddress
                            ].balanceOf.call(dfPool.address);
                            accountTokenBalanceCurrent = await collateralObject[
                                tokenAddress
                            ...
                            console.log(
                                dfStoreLockTokenBalanceCurrent.toString()
                            );
                            ...
                            console.log(
                                "collateral current account token balance:"
                            );
                            ...
                            xAmount = await xCollateralObject[
                                xTokenAddress
                    ...
                    case runType == "claim":
                        while (condition < runTimes) {
                            ...
                            calcMaxClaimAmount = await dfProtocolView.getUserMaxToClaim.call(
                                { from: accountAddress }
                            );
                            ...
                            console.log(
                                dfStoreAccountTokenTotalOrigin.toString()
                            );
                            console.log("\n");
                            ...
                            try {
                                ...
                                runData["usdx_balance current"] = (
                                    await usdxToken.balanceOf.call(
                                        accountAddress
                                    )
                                ).toString();
                            ...
                            console.log(
                                "claim account address : " + accountAddress
                            );
                            console.log("\n");
                    ...
                    case runType == "oneClickMinting":
                        while (condition < runTimes) {
                            ...
                            console.log(
                                "minting account index : " +
                                    accounts.indexOf(accountAddress)
                            );
                            console.log(
                                "minting account address : " + accountAddress
                            );
                            console.log("\n");
                            ...
                            for (
                                ...
                                assert.equal(
                                    dfProtocolMintingSection[0][index],
                                    tokenAddressList[index]
                                );
                                assert.equal(
                                    dfProtocolMintingSection[1][
                                        index
                                    ].toString(),
                                    tokenWeightList[index].toString()
                                );
                                ...
                                cwSum = cwSum.add(
                                    dfProtocolMintingSection[1][index]
                                );
                            }
                            ...
                            for (
                                ...
                                srcTokenAmount = await xCollateralObject[
                                    ...
                                    tokenAmount[tokenAddressList[index]]
                                );
                                console.log("-------------------------");
                                ...
                                await collateralObject[
                                    tokenAddressList[index]
                                ].approve(dfPool.address, srcTokenAmount, {
                                    from: accountAddress,
                                });
                            ...
                            try {
                                transactionData = await dfProtocol.oneClickMinting(
                                    new BN(0),
                                    amountNB,
                                    { from: accountAddress }
                                );
                    ...
                    case runType == "updateSection":
                        while (condition < runTimes) {
                            ...
                            tokenWeightListNew = DataMethod.createMixIndexData(
                                weightTest,
                                weightTest.length,
                                weightTest.length
                            );
                            tokenAddressIndex = DataMethod.createIndex(
                                collateralAddress,
                                tokenWeightListNew.length - 1,
                                tokenWeightListNew.length - 1
                            );
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    tokenWeightListNew =
                                        runConfig[configIndex]["data"][
                                            dfEngineIndex
                                        ]["data"][conditionIndex]["weight"];
                                }

                                tokenAddressListNew = [];
                                var collateralAddressLength =
                                    collateralAddress.length;
                                for (
                                    let index = 0;
                                    index < tokenAddressIndex.length;
                                    index++
                                ) {
                                    if (
                                        tokenAddressIndex[index] <=
                                            (randomFlag ? -1 : 0) ||
                                        tokenAddressIndex[index] >
                                            collateralAddressLength
                                    ) {
                                ...
                                if (tokenWeightListNew.length == 0) {
                                    tokenWeightListNew = DataMethod.createData(
                                        weightTest,
                                        tokenAddressListNew.length,
                                        tokenAddressListNew.length
                                    );
                                }
                            }
                            ...
                            for (
                                let index = 0;
                                index < tokenWeightListNew.length;
                                index++
                            ) {
                                tokenWeightListNew[index] = new BN(
                                    (tokenWeightListNew[index] * 10 ** 18)
                                        .toLocaleString()
                                        .replace(/,/g, "")
                                );
                            ...
                            try {
                                transactionData = await dfSetting.updateMintSection(
                                    xTokenAddressList,
                                    tokenWeightListNew,
                                    { from: owner }
                                );
                            ...
                            dfStoreTokenAddress = await dfStore.getSectionToken.call(
                                dfStoreMintPosition
                            );
                            ...
                            dfStoreTokenWeight = await dfStore.getSectionWeight.call(
                                dfStoreMintPosition
                            );
                            ...
                            for (
                                let index = 0;
                                index < dfStoreTokenAddress.length;
                                index++
                            ) {
                                assert.equal(
                                ...
                                assert.equal(
                                    dfStoreTokenAddress[index],
                                    await dfStore.getWrappedToken.call(
                                        tokenAddressList[index]
                                    )
                                );
                                assert.equal(
                            ...
                            for (
                                ...
                                assert.equal(
                                    await dfStore.getMintedToken.call(
                                        xTokenAddress
                                    ),
                                    true
                                );
                                if (
                                    dfStoreTokenAddress.indexOf(
                                        xTokenAddress
                                    ) >= 0
                                )
                                    assert.equal(
                                        await dfStore.getMintingToken.call(
                                            xTokenAddress
                                        ),
                                        true
                                    );
                    ...
                    case runType == "changeEngine":
                        while (condition < runTimes) {
                            ...
                            console.log(
                                "dfEngine address : " + dfEngine.address
                            );
                            console.log("\n");
                            ...
                            accountAddress =
                                accounts[
                                    MathTool.randomNum(0, accounts.length - 1)
                                ];
                            ...
                            await dfProtocol.requestImplChange(
                                dfEngine.address
                            );
                            await dfProtocol.confirmImplChange();
                            console.log(
                                "dfEngine new address : " + dfEngine.address
                            );
                            console.log("\n");
                            condition++;
                        }
                    ...
                    case runType == "setMinBurnAmount":
                        while (condition < runTimes) {
                            ...
                            runData["amountNB"] = amountNB.toString();
                            try {
                                transactionData = await dfSetting.setDestroyThreshold(
                                    amountNB,
                                    { from: owner }
                                );
                            ...
                            assert.equal(
                                (
                                    await dfProtocol.getDestroyThreshold.call()
                                ).toString(),
                                amountNB.toString()
                            );
                            condition++;
