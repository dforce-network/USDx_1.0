...
function createMixIndexData(sourceData, lengthMin = 2, lengthMax = sourceData.length){ 
    let dataList = [];
    ...
    for (let index = 0; index < lengthMax; index++) {
        ...
        randomIndex = MathTool.randomNum(0, sourceData.length - 1);
...
module.exports = {
    ...
    createMixIndexData    : createMixIndexData,
};