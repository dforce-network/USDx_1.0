...
// Unmute if want to check the debug messages
    ...
    switch (true) {
      case runType == "deposit":
        while (condition < runTimes) {
          ...
          var tokenDecimals =
            collateralDecimals[collateralAddress.indexOf(tokenAddress)];
          var xTokenAddress = await dfStore.getWrappedToken.call(tokenAddress);
          assert.equal(
            xTokenAddress,
            xCollateralAddress[collateralAddress.indexOf(tokenAddress)]
          );
          assert.equal(
            tokenDecimals.toString(),
            (
              await xCollateralObject[xTokenAddress].srcDecimals.call()
            ).toString()
          );
          assert.equal(
            tokenAddress,
            await xCollateralObject[xTokenAddress].getSrcERC20.call()
          );
          ...
          var amountReal = await xCollateralObject[
            ...
            await xCollateralObject[xTokenAddress].changeByMultiple.call(
              amountNB
            )
          );
          console.log(
          ...
          await collateralObject[tokenAddress].approve(
            dfPool.address,
            new BN(0),
            {
              from: accountAddress,
          ...
          for (let index = 0; index < collateralAddress.length; index++) {
            ...
            dfStoreTokenBalance[
              xTokenAddress
            ] = await dfStore.getTokenBalance.call(xTokenAddress);
            ...
            dfStoreLockTokenBalance[
              xTokenAddress
            ] = await dfStore.getResUSDXBalance.call(xTokenAddress);
            ...
            dfPoolTokenBalance[xTokenAddress] = await xCollateralObject[
              xTokenAddress
            ...
            dfCollateralTokenBalance[xTokenAddress] = await xCollateralObject[
              xTokenAddress
          ...
          for (let index = 0; index < collateralAddress.length; index++) {
            ...
            dfPoolSrcTokenBalance[
              collateralAddress[index]
            ] = await collateralObject[collateralAddress[index]].balanceOf.call(
              dfPool.address
            );
            balanceOfSrcTokens = await xCollateralObject[
              xTokenAddress
            ].changeByMultiple.call(
              dfPoolSrcTokenBalance[collateralAddress[index]]
            );
            dfPoolSrcTokenTotal = dfPoolSrcTokenTotal.add(balanceOfSrcTokens);

            dfPoolSrcTokenBalance[
              collateralAddress[index]
            ] = dfPoolSrcTokenBalance[collateralAddress[index]].toString();
      ...
      case runType == "destroy":
        while (condition < runTimes) {
          ...
          await usdxToken.approve(dfEngine.address, new BN(0), {
            from: accountAddress,
          });
          await usdxToken.approve(dfEngine.address, amountNB, {
            from: accountAddress,
          });
          ...
          runData["pool src token balance"] = dfPoolSrcTokenBalance;
          try {
            transactionData = await dfProtocol.destroy(new BN(0), amountNB, {
              from: accountAddress,
            });
            destroyGasUsed =
          ...
          assert.equal(
            (
              await usdxToken.allowance.call(accountAddress, dfEngine.address)
            ).toString(),
            "0"
          );
          assert.equal(
            (
              await dfToken.allowance.call(accountAddress, dfEngine.address)
            ).toString(),
            "0"
          );
      ...
      case runType == "withdraw":
        while (condition < runTimes) {
          ...
          tokenAddress =
            collateralAddress[
              MathTool.randomNum(0, collateralAddress.length - 1)
            ];
          accountAddress = accounts[MathTool.randomNum(1, accounts.length - 1)];
          ...
          amountTotal =
            dfWithdrawBalances[1][dfWithdrawBalances[0].indexOf(tokenAddress)];
          amount = MathTool.randomNum(
            0,
      ...
      case runType == "claim":
        while (condition < runTimes) {
          ...
          try {
            ...
            transactionData = await dfProtocol.claim(new BN(0), {
              from: accountAddress,
            });
            claimGasUsed =
            ...
            runData["claim amount"] =
              runData["usdx_balance current"] - runData["usdx_balance origin"];
            runData["gasUsed"] = transactionData.receipt.gasUsed;
            runData["gasUsed ETH"] =
              (transactionData.receipt.gasUsed * gasPrice) / 10 ** 18;
            runData["result"] = "success";
          ...
          assert.equal(
            (await usdxToken.balanceOf.call(dfPool.address)).toString(),
            dfStoreLockTokenTotalOrigin.sub(amountNB).toString()
          );
          assert.equal(
            (await usdxToken.balanceOf.call(dfPool.address)).toString(),
      ...
      case runType == "oneClickMinting":
        while (condition < runTimes) {
          ...
          for (
            ...
            assert.equal(
              dfProtocolMintingSection[1][index].toString(),
          ...
          for (let index = 0; index < tokenAddressList.length; index++) {
            ...
            accountTokenBalanceMapOrigin[
              tokenAddressList[index]
            ] = await collateralObject[tokenAddressList[index]].balanceOf.call(
              accountAddress
            );
            balanceOfSrcTokens = await xCollateralObject[
              xTokenAddress
            ...
            await collateralObject[tokenAddressList[index]].approve(
              dfPool.address,
              new BN(0),
              {
                from: accountAddress,
            ...
            runData["token amount"][
              collateralAddress.indexOf(tokenAddressList[index])
            ] =
              srcTokenAmount /
              10 **
                (
          ...
          for (let index = 0; index < collateralAddress.length; index++) {
            ...
            if (
              ...
              balanceOfSrcTokens = await xCollateralObject[
                ...
                accountTokenBalanceMapCurrent[collateralAddress[index]]
              );
              accountTokenTotalCurrent = accountTokenTotalCurrent.add(
                balanceOfSrcTokens
              );
              assert.equal(
                accountTokenBalanceMapOrigin[collateralAddress[index]]
                  .sub(tokenAmount[collateralAddress[index]])
                  .toString(),
                accountTokenBalanceMapCurrent[
                  collateralAddress[index]
                ].toString()
        ...
        while (condition < runTimes) {
          ...
          if (
            ...
            for (let index = 0; index < tokenAddressIndex.length; index++) {
              if (
                ...
                tokenAddressIndex[index] > collateralAddressLength
              ) {
          ...
          for (let index = 0; index < tokenWeightListNew.length; index++) {
            ...
            xTokenAddressList.push(
              xCollateralAddress[
                collateralAddress.indexOf(tokenAddressListNew[index])
              ]
            );
          ...
          for (let index = 0; index < dfStoreTokenAddress.length; index++) {
            ...
            assert.equal(
              ...
              await dfStore.getWrappedToken.call(tokenAddressList[index])
            );
            assert.equal(
          ...
          for (let index = 0; index < collateralAddress.length; index++) {
            ...
            assert.equal(
              (
                await xCollateralObject[xTokenAddress].balanceOf.call(
                  dfPool.address
                )
              ).toString(),
            ...
            assert.equal(
              await dfStore.getMintedToken.call(xTokenAddress),
              true
            );
            if (dfStoreTokenAddress.indexOf(xTokenAddress) >= 0)
              assert.equal(
                await dfStore.getMintingToken.call(xTokenAddress),
                true
              );
            else
              assert.equal(
      ...
      case runType == "changeEngine":
        while (condition < runTimes) {
          ...
          runData["amountNB"] = amountNB.toString();
          runData[
            (await collateralObject[tokenAddress].name.call()) + " balance"
          ] = accountTokenBalanceOrigin.toString();
          try {
            transactionData = await dfProtocol.deposit(
              tokenAddress,
      ...
      case runType == "setMinBurnAmount":
        while (condition < runTimes) {
          ...
          runData["amountNB"] = amountNB.toString();
          try {
            transactionData = await dfSetting.setDestroyThreshold(amountNB, {
              from: owner,
            });
          ...
          assert.equal(
            (await dfProtocol.getDestroyThreshold.call()).toString(),
            amountNB.toString()
          );
          condition++;
        }
