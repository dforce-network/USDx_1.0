...
contract("USDx", (accounts) => {
    ...
    for (let configIndex = 0; configIndex < runConfig.length; configIndex++) {
        ...
        it("Init the deploy contract", async () => {
            ...
            for (
                let index = 0;
                index < wrapTokenAddress[system].length;
                index++
            ) {
        ...
        it("Verify USDx System after construction", async () => {
            ...
            while (dfEngineTimes < configTimes) {
                ...
                system = runConfig[configIndex]["data"][
                    dfEngineIndex
                ].hasOwnProperty("sys")
                ...
                switch (true) {
                    case runType == "deposit":
                        while (condition < runTimes) {
                            ...
                            var tokenDecimals =
                                srcTokenDecimals[
                                    srcTokenAddress.indexOf(tokenAddress)
                                ];
                            var xTokenAddress = await dfStore[
                                system
                            ].getWrappedToken.call(tokenAddress);
                            assert.equal(
                                xTokenAddress,
                                wrapTokenAddress[system][
                                    srcTokenAddress.indexOf(tokenAddress)
                            ...
                            var tokenName = await srcTokenContract[
                                tokenAddress
                            ].name.call();
                            ...
                            try {
                                transactionData = await dfProtocol[
                                    system
                                ].deposit(tokenAddress, new BN(0), amountNB, {
                                    from: accountAddress,
                                });
                                depositGasUsed =
                                    depositGasUsed <
                            ...
                            for (
                                let index = 0;
                                index < srcTokenAddress.length;
                                index++
                            ) {
                                xTokenAddress = await dfStore[
                                    system
                                ].getWrappedToken.call(srcTokenAddress[index]);

                                dfStoreTokenBalance[
                                    xTokenAddress
                                ] = await dfStore[system].getTokenBalance.call(
                                    xTokenAddress
                                );
                            ...
                            for (
                                ...
                                withdrawAmount = dfStoreTokenBalance[
                                    ...
                                    ? dfStoreTokenBalance[xTokenAddress]
                                    : dfStoreAccountToken[xTokenAddress];
                                srcTokenAmount = await wrapTokenContract[
                                    system
                                ][xTokenAddress].reverseByMultiple.call(
                                    withdrawAmount
                                );
                                assert.equal(
                                ...
                                balanceOfSrcTokens = await wrapTokenContract[
                                    system
                                ][xTokenAddress].changeByMultiple.call(
                                    dfPoolSrcTokenBalance[
                                        srcTokenAddress[index]
                                    ]
                                );
                            ...
                            dfStoreMintedTotal = await dfStore[
                                system
                            ].getTotalMinted.call();
                    ...
                    case runType == "destroy":
                        while (condition < runTimes) {
                            ...
                            burnedTotalOrigin = await dfStore[
                                system
                            ].getTotalBurned.call();
                            burnedOrigin = await dfStore[
                                system
                            ].getSectionBurned.call(
                            ...
                            for (
                                ...
                                balanceOfTokens = await wrapTokenContract[
                                    system
                                ][xTokenAddress].balanceOf.call(
                                    dfPool[system].address
                                );
                                dfPoolTokenTotal = dfPoolTokenTotal.add(
                                    balanceOfTokens
                            ...
                            dfStoreTotalColOrigin = await dfStore[
                                system
                            ].getTotalCol.call();
                            ...
                            burnedTotalCurrent = await dfStore[
                                system
                            ].getTotalBurned.call();
                            burnedCurrent = await dfStore[
                                system
                            ].getSectionBurned.call(
                                await dfStore[system].getBurnPosition.call()
                            );
                            ...
                            dfStoreTotalColCurrent = await dfStore[
                                system
                            ].getTotalCol.call();
                    ...
                    case runType == "withdraw":
                        while (condition < runTimes) {
                            ...
                            dfPoolTokenBalanceOrigin = await wrapTokenContract[
                                system
                            ][xTokenAddress].balanceOf.call(
                                dfPool[system].address
                            );
                            ...
                            dfPoolTokenBalanceCurrent = await wrapTokenContract[
                                system
                            ][xTokenAddress].balanceOf.call(
                                dfPool[system].address
                            );
                    ...
                    case runType == "claim":
                        while (condition < runTimes) {
                            ...
                            for (
                                ...
                                console.log(
                                    "token address : " + srcTokenAddress[index]
                                );
                                console.log(
                    ...
                    case runType == "oneClickMinting":
                        while (condition < runTimes) {
                            ...
                            for (
                                ...
                                xTokenAddress = await dfStore[
                                    system
                                ].getWrappedToken.call(tokenAddressList[index]);
                                ...
                                await srcTokenContract[
                                    tokenAddressList[index]
                                ].approve(dfPool[system].address, new BN(0), {
                                    from: accountAddress,
                                });
                                tokenAmount[
                                    tokenAddressList[index]
                    ...
                    case runType == "updateSection":
                        while (condition < runTimes) {
                            ...
                            dfStoreTokenAddress = await dfStore[
                                system
                            ].getSectionToken.call(dfStoreMintPosition);
                            console.log("dfStore collateral address :");
                            console.log(dfStoreTokenAddress);
                            console.log("\n");

                            dfStoreTokenWeight = await dfStore[
                                system
                            ].getSectionWeight.call(dfStoreMintPosition);
                            ...
                            for (
                                ...
                                assert.equal(
                                    await dfStore[system].getMintedToken.call(
                                        xTokenAddress
                                    ),
                                    true
                                );
                                if (
                                    ...
                                    assert.equal(
                                        await dfStore[
                                            system
                                        ].getMintingToken.call(xTokenAddress),
                                        true
                                    );
                                else
                                    assert.equal(
                    ...
                    case runType == "dataMigration":
                        while (condition < runTimes) {
                            ...
                            for (
                                ...
                                srcName = await srcTokenContract[
                                    srcToken
                                ].symbol.call();
                                ...
                                mintedTokenMap[mintedTokenList[index]] =
                                    wrappedToken.address;
                                ...
                                balanceOfTokens = await wrapTokenContract[
                                    system
                                ][mintedTokenList[index]].balanceOf.call(
                                    dfCollateral[system].address
                                );
                                ...
                                dfTokenBalance = await dfStore[
                                    system
                                ].getTokenBalance.call(mintedTokenList[index]);
                            ...
                            var sectionData = await dfStore[
                                system
                            ].getSectionData.call(new BN(0));
                            var xTokenAddressList = [];
                            for (
                                let index = 0;
                                index < sectionData[3].length;
                                index++
                            )
                                xTokenAddressList[index] =
                            ...
                            var mintPosition = await dfStore[
                                system
                            ].getMintPosition.call();
                            condition = new BN(1);
                            while (condition.lte(mintPosition)) {
                                sectionData = await dfStore[
                                    system
                                ].getSectionData.call(condition);
                                xTokenAddressList = [];
                                for (
                                    let index = 0;
                                    index < sectionData[3].length;
                            ...
                            await usdxToken.setAuthority(
                                dfEngine[systemNew].address
                            );
                            await dfToken.setAuthority(
                                dfEngine[systemNew].address
                            );

                            await dfStore[systemNew].setAuthority(
                                dSGuard.address
                            );
                            await dfCollateral[systemNew].setAuthority(
                                dSGuard.address
                            );
                            await dfPool[systemNew].setAuthority(
                                dSGuard.address
                            );
                            await dfEngine[systemNew].setAuthority(
                                dSGuard.address
                            );
                            await dfSetting[systemNew].setAuthority(
                                dSGuard.address
                            );
                            ...
                            await dfSetting[systemNew].setCommissionToken(
                                0,
                                dfToken.address
                            );
                            ...
                            for (
                                let index = 0;
                                index < dfEngine[system].abi.length;
                                index++
                            )
                ...
                if (
                    ...
                    for (
                        ...
                        for (
                            ...
                            console.log(
                                "dfpool src token balance : " + balanceOfTokens
                            );
                            ...
                            balanceOfTokens = await wrapTokenContract[
                                systemIndex
                            ][wrapTokenList[index]].balanceOf.call(
                                dfPool[systemIndex].address
                            );
                            console.log(
                                "dfpool wrap token balance : " + balanceOfTokens
                            );
                            assert.equal(balanceOfTokens.toString(), "0");
                            balanceOfTokens = await wrapTokenContract[
                                systemIndex
                            ][wrapTokenList[index]].balanceOf.call(
                                dfCollateral[systemIndex].address
                            );
                            console.log(
                                "dfCollateral wrap token balance : " +
                                    balanceOfTokens
                            );
                            assert.equal(balanceOfTokens.toString(), "0");
                            ...
                            dfTokenBalance = await dfStore[
                                systemIndex
                            ].getTokenBalance.call(wrapTokenList[index]);
                            console.log(
                                "dfStore poolBalance : " + dfTokenBalance
                            );
                            ...
                            console.log(
                                "dfStore resUSDXBalance : " + dfTokenBalance
                            );
                            assert.equal(dfTokenBalance.toString(), "0");
                    ...
                    console.log(
                        (await usdxToken.totalSupply.call()).toString()
                    );
                    assert.equal(
                        (await usdxToken.totalSupply.call()).toString(),
                        "0"
